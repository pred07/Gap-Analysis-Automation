...
"""
    ...
    <div class="header">
        <div class="header-content">
            <h1>🛡️ Security GAP Analysis Report</h1>
...
"""
    ...
    def _create_control_breakdown(self, controls_summary: Dict[str, Any]) -> str:
        ...
        if not_tested_controls:
            for ctrl in not_tested_controls[:15]:  # Show first 15
                not_tested_html += f"<li>{format_control(ctrl)}</li>"
            if len(not_tested_controls) > 15:
                not_tested_html += f"<li><em>... and {len(not_tested_controls) - 15} more</em></li>"
        else:
...
"""
    ...
    def _create_enhanced_footer(self, results: Dict[str, Any]) -> str:
        ...
        return """
    <div class="footer">
        <div class="footer-logo">🛡️ Security GAP Analysis System</div>
...
"""
    ...
    def _get_enhanced_scripts(
        ...
        return f"""
    <script>
        console.log('🛡️ Security GAP Analysis Dashboard loaded');
